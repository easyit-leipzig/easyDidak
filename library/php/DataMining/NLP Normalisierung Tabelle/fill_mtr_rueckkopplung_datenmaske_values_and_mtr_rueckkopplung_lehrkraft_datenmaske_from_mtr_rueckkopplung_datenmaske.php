...
/* get values */ 
$r_vals = $pdo -> query("select id, id_mtr_rueckkopplung_datenmaske, value from sql_rueckkopplung_datenmaske_values
                           where length(value)>40 and value not in (select real_value from frzk_funktionsklassen_weight_absprachen) order by id") -> fetchAll(PDO::FETCH_ASSOC);
